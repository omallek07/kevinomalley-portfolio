...
const AboutMe = () => {
  const aboutMetext = `Clean code, problem solving, having my dog jump on my keyboard ansaadsasjfja...I love it all. My name is Kevin O'Malley and welcome to my web page. I am a full stack software engineer with a focus in JavaScript. Please check out my projects and blog posts or
  `;
